...
const RELATION_PROVENANCE: Record<RelationProvenanceKind, RelationProvenance> = {
  ...
  same_work_number: {
    ...
    label: "Mismo número de obra",
    confidence: "high",
    caveat: "El número de obra puede conectar registros de una misma obra; requiere abrir los receipts para confirmar alcance y etapa.",
  },
  normalized_name: {
    kind: "normalized_name",
    label: "Nombre normalizado",
    confidence: "low",
    caveat: "La coincidencia por nombre normalizado puede unir homónimos o variantes; verificar CUIT, domicilio o registro oficial antes de citar.",
  },
  judicial_context: {
    kind: "judicial_context",
    label: "Fuente judicial contextual",
    confidence: "medium",
    caveat: "La fuente judicial aporta contexto documental; no prueba por sí sola nada sobre otros expedientes Faro.",
  },
  user_suggested: {
    kind: "user_suggested",
    label: "Sugerido por usuario",
    confidence: "low",
    caveat: "La relación fue cargada como hipótesis de trabajo privada y requiere revisión antes de cualquier uso público.",
  },
};
