      ...
      messages: [
        {
          ...
          content: [
            ...
            "Priorizá utilidad práctica: hipótesis de trabajo verificables, brechas y el próximo paso concreto.",
...
export function buildInvestigationPrompt(input: MinimaxInvestigationAnalysisInput): string {
  return [
    ...
    "Devolvé Markdown con estas secciones: Resumen, Matriz de trabajo, Cruces, Brechas, Próximos pasos.",
    "En Matriz de trabajo usá una sola tabla Markdown simple, máximo 6 filas, con columnas: Punto de revisión, Soporte en Faro, Brecha, Próximo paso concreto.",
    "Fuera de esa tabla, usá bullets cortos y acciones verificables; evitá tablas largas y texto decorativo.",
